defmodule HelloWeb.ProductControllerTest do
  ...
  @create_attrs %{description: "some description", price: "120.5", title: "some title", view: 42}
  @update_attrs %{description: "some updated description", price: "456.7", title: "some updated title", view: 43}
  @invalid_attrs %{description: nil, price: nil, title: nil, view: nil}
